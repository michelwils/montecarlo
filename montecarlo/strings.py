...
CHART_STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "console_board_todo_pts":     "{n} pts To Do ({count} cards)",
        "console_board_wip_pts":      "{n} pts WIP ({count} cards)",
        "console_board_todo_skipped": "{n} To Do card(s) skipped (no size value)",
        "console_board_wip_skipped":  "{n} WIP card(s) skipped (no size value)",
        "mix_board_todo":             "{n} pts To Do ({count} cards)",
        "mix_board_wip":              "{n} pts WIP ({count} cards)",
    ...
    "fr": {
        ...
        "console_board_todo_pts":     "{n} pts à faire ({count} cartes)",
        "console_board_wip_pts":      "{n} pts en cours ({count} cartes)",
        "console_board_todo_skipped": "{n} carte(s) à faire ignorée(s) (pas de valeur de taille)",
        "console_board_wip_skipped":  "{n} carte(s) en cours ignorée(s) (pas de valeur de taille)",
        "mix_board_todo":             "{n} pts à faire ({count} cartes)",
        "mix_board_wip":              "{n} pts en cours ({count} cartes)",
